 ...
 * @return array
 */
function trishasalas_body_classes( $classes ) {
...
add_filter( 'body_class', 'trishasalas_body_classes' );
 ...
 */
function trishasalas_oembed_flex_wrapper( $html, $url, $attr, $post_ID ) {
...
add_filter( 'embed_oembed_html', 'trishasalas_oembed_flex_wrapper', 10, 4 );