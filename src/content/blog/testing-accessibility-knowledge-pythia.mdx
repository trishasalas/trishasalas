...
|--------|-------|------|----|------| ------|
|A screen reader is| incorrect | incorrect | partially correct | correct | correct |
|WCAG stands for|incorrect|incorrect|incorrect| incorrect |correct|
|A skip link is|incorrect|incorrect|incorrect|incorrect| incorrect |
|The purpose of alt text is|incorrect|incorrect|incorrect| correct |correct|
|ARIA stands for|incorrect |incorrect|incorrect| incorrect |incorrect|
|Captions are used for|incorrect|partially correct|incorrect| partially correct |incorrect|
...
| Prompt | 160M| 410M | 1B | 2.8B| 6.9B|
| --------------------------------------------------- | ------------------- | ------------------ | ---------------- | ----------------------------------------- | ----------------------------------------- |
| `<img src='photo.jpg'>` is missing | incorrect | incorrect | incorrect | incorrect | incorrect |
| A `<div>` with onclick is not accessible because | incorrect | incorrect | incorrect | incorrect | partially correct |
| `<input type='text'>` needs a| incorrect | incorrect | incorrect | incorrect | incorrect |
| A button that only says 'Click here' is bad because | incorrect | incorrect | incorrect | incorrect | correct |
